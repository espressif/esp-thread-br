...
Follow the steps below to obtain the latest esp-thread-br main branch and the recommended ESP-IDF version `v5.5.4 <https://github.com/espressif/esp-idf/tree/v5.5.4>`_ release:
